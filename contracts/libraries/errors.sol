...
string constant ERROR_5 = "Winnershares length does not match number of winners";
...
string constant ERROR_25 = "Not more than 10 winners per lotto/pot";
string constant ERROR_26 = "Sum of winningShares array elements must be 100 (100%)";
